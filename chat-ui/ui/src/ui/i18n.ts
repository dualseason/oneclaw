...
const dict: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "chat.image": "图片",
    "chat.generateImageFailed": "生图失败",
    "chat.generateImageBusy": "当前有未完成的请求，请等待后再试生图。",
    "chat.generateImageNoAttachments": "当前生图入口暂不支持参考图，请先移除粘贴的图片再试。",
    "chat.generatingImageStatus": "正在生图，提示词：",
  ...
  en: {
    ...
    "chat.placeholder.generatingImage": "Generating image…",
    ...
    "chat.image": "Image",
    "chat.generateImageFailed": "Image generation failed",
    "chat.generateImageBusy": "Another request is still running. Wait for it to finish before generating an image.",
    "chat.generateImageNoAttachments": "This image generation action does not support reference images yet. Remove attachments and try again.",
    "chat.generatingImageStatus": "Generating image with prompt:",
